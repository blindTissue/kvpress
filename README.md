...
- `QueryZipPress` ([source](kvpress/presses/queryzip_press.py), [guide](docs/queryzip.md), [base KVzip paper](https://arxiv.org/abs/2505.23416)): QueryZip+ blends KVzip+ reconstruction importance with trailing-question attention. Query-aware, rank fusion by default, with no hard reserve. Requires reconstruction passes and uses masked eviction.
